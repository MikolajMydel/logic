...
const ControlPanel = (props) => (
    <nav className={ styles.ControlPanel }>
        ...
        <button onClick={ () => props.addElement ( { type: "logicGate", gateLogic: "OR", inputCount: 10 } ) } > Bramka testowa (10 wejść) </button>
        <button onClick={ () => props.addElement ( { type: "logicGate", gateLogic: "NOT", inputCount: 1 } ) } > Bramka NOT </button>
    </nav>
)
