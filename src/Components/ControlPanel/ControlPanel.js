...
const ControlPanel = (props) => (
    <nav className={ styles.ControlPanel }>
        <button onClick={ () => props.addElement ( { type: "startNode", value: true } ) } > Węzeł prawda </button>
        <button onClick={ () => props.addElement ( { type: "startNode", value: false } ) } > Węzeł fałsz </button>
